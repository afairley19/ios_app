...
class SettingsViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    let sortOrderItems: Array<String> = ["contactName", "city", "birthday", "cellNumber", "email"]
    ...
    // return # of 'columns' for display
    func numberOfComponents(in pickerView: UIPickerView) -> Int {
        return 1
    }
    
    // return # of rows in picker
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        return sortOrderItems.count
    }
    
    // set value to be shown for each row in picker
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        return sortOrderItems[row]
    }
    
    // calls function if user chooses pickerview
